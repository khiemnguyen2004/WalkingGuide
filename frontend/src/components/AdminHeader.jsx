...
const AdminHeader = () => {
  ...
  return (
    <header className="luxury-header fixed-top" style={{zIndex: 1060, background: 'linear-gradient(90deg, #b6e0fe 0%, #5b9df9 100%)', minHeight: 56, left: 220, width: 'calc(100% - 220px)', padding: 0}}>
      <div className="container d-flex flex-row align-items-center justify-content-between py-1" style={{minHeight: 56}}>
        <div className="d-flex align-items-center gap-2">
          ...
          <span className="fw-bold" style={{fontSize: '1.08rem', letterSpacing: '1px'}}>Admin Dashboard</span>
        </div>
        <div className="d-flex align-items-center gap-2">
